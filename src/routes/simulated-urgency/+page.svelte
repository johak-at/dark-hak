<script>
    ...
    const products = [
      ...
      { name: "Geforce RTX 3080", description: "1.440 MHz, 10 GB GDDR6X, 29,8 TFLOPS", pic: "https://storage-asset.msi.com/global/picture/image/feature/vga/NVIDIA/RTX3090/RTX3090_Ti_gamingTrio/3090-ti-vga-body.png", countdown: { days: 10, hours: 5, minutes: 30, seconds: 0 } },
  ...
  <div class="boxes">
    {#each products as { name, description, pic, countdown }, index}
